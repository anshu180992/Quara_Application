      ...
      <>
        ...
        <div className="p-4">
          <div className="flex items-center space-x-2 mb-3">
            <img className="rounded-full bg-gray-300 h-6 w-6" src={profilepic} alt="A" />
    ...
    {tab === "Create Post" && (
      <>
        <div className="flex items-center px-4 py-3 space-x-3">
          ...
          />
          <div>
            <h4 className="font-semibold text-gray-800">Anshu Gangrade</h4>
            <select className="text-sm border rounded-full px-2 py-1 hover:bg-gray-100">
              <option value="Indore">lives in Indore</option>
