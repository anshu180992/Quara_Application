...
const Navbar = () => {
  ...
  <path  d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2M8 1.918l-.797.161A4 4 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4 4 0 0 0-3.203-3.92zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5 5 0 0 1 13 6c0 .88.32 4.2 1.22 6"/>
        ...
        {/* Search Bar */}
        <div className="flex border  p-2 mx-3 mb-3 hover:border-blue-700 hover:bg-black-900 sm:w-72">
          <img src={lens} alt="Search" className="w-5 h-5 mt-1 ml-1" />
          <input
            placeholder="Search Quora"
            className="ml-1 outline-none  h-5 w-full"
          />
        </div>

        {/* Profile and Try Quora+ */}
        <div className="flex items-center space-x-2 sm:space-x-6 mb-3">
          <h1 className="text-sm border rounded-full pt-1 pb-1 pl-1 pr-1 hidden sm:block h-9  w-full text-gray-500 hover:bg-gray-200">
            Try Quora+
          </h1>
          <img src={globe} alt="Globe" className="w-5 h-5 cursor-pointer hover:text-red-400 " />
          <Avatar src={profilepic}  className=" cursor-pointer " />

         {/* Add Quations */}
          <h1
            onClick={() => setIsOpen(true)}
            className="bg-red-700  text-sm cursor-pointer pt-1 text-white w-full h-9 rounded-full"
          >
            Add Question
          </h1>
          {isOpen && (
